...
def ADAR_set_CalRxPhase(beam_list, Ph_Diff, cal_element):
    ...
    if sw_tx == 2:
        if cal_element == 1:
            beam0_ph = [Phase_1, Phase_2, 0, 0]
            beam1_ph = [0, 0, 0, 0]

        elif cal_element == 2:
            beam0_ph = [0, Phase_1, Phase_2, 0]
            beam1_ph = [0, 0, 0, 0]

        elif cal_element == 3:
            beam0_ph = [0, 0, Phase_1, Phase_2]
            beam1_ph = [0, 0, 0, 0]
