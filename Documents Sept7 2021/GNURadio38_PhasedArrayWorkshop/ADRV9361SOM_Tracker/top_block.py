...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def set_Rx8_Cal(self, Rx8_Cal):
        ...
        self.ADAR1000_Dual_Sweeper.Rx8_cal = float(self.Rx8_Cal+self.Rx1_to_Rx2_Offset+109.6875)
    ...
    def set_Rx7_Cal(self, Rx7_Cal):
        ...
        self.ADAR1000_Dual_Sweeper.Rx7_cal = float(self.Rx7_Cal+self.Rx1_to_Rx2_Offset+112.5)
    ...
    def set_Rx6_Cal(self, Rx6_Cal):
        ...
        self.ADAR1000_Dual_Sweeper.Rx6_cal = float(self.Rx6_Cal+self.Rx1_to_Rx2_Offset+101.25)
    ...
    def set_Rx5_Cal(self, Rx5_Cal):
        ...
        self.ADAR1000_Dual_Sweeper.Rx5_cal = float(self.Rx5_Cal+self.Rx1_to_Rx2_Offset+75.9375)
    ...
    def set_Rx4_Cal(self, Rx4_Cal):
        ...
        self.ADAR1000_Dual_Sweeper.Rx4_cal = float(self.Rx4_Cal)
    ...
    def set_Rx3_Cal(self, Rx3_Cal):
        ...
        self.ADAR1000_Dual_Sweeper.Rx3_cal = float(self.Rx3_Cal+11.25)
    ...
    def set_Rx2_Cal(self, Rx2_Cal):
        ...
        self.ADAR1000_Dual_Sweeper.Rx2_cal = float(self.Rx2_Cal+30.9375)
    ...
    def set_Rx1_Cal(self, Rx1_Cal):
        ...
        self.ADAR1000_Dual_Sweeper.Rx1_cal = float(self.Rx1_Cal+33.75)
