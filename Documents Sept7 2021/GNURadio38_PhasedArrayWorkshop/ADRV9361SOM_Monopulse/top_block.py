...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        for c in range(0, 2):
            self.ControlTab_grid_layout_2.setColumnStretch(c, 1)
        self._Center_freq_range = Range(10000, 11000, 4, 10109, 10)
    ...
    def set_LO_freq(self, LO_freq):
        ...
        self.ADAR1000_8_sweeper.LO_freq = int((self.Center_freq-self.LO_freq)*1000000)
        self.ADAR1000_8_sweeper.TX_freq = int(self.LO_freq*1000000)
    ...
    def set_Center_freq(self, Center_freq):
        ...
        self.ADAR1000_8_sweeper.LO_freq = int((self.Center_freq-self.LO_freq)*1000000)
        self.ADAR1000_8_sweeper.SignalFreq = int((self.Center_freq-self.BW)*1000000)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.ADAR1000_8_sweeper.SampleRate = int(self.samp_rate)
    ...
    def set_Times_To_Average(self, Times_To_Average):
        ...
        self.ADAR1000_8_sweeper.Averages = int(self.Times_To_Average)
    ...
    def set_SymmetricTaper(self, SymmetricTaper):
        ...
        self._SymmetricTaper_callback(self.SymmetricTaper)
        self.ADAR1000_8_sweeper.SymTaper = int(self.SymmetricTaper)
    ...
    def set_Rx_gain(self, Rx_gain):
        ...
        self.ADAR1000_8_sweeper.Rx_gain = int(self.Rx_gain)
    ...
    def set_Rx8_Cal(self, Rx8_Cal):
        ...
        self.ADAR1000_8_sweeper.Rx8_cal = float(self.Rx8_Cal+self.Rx1_to_Rx2_Offset+109.6875)
    ...
    def set_Rx8Gain(self, Rx8Gain):
        ...
        self.ADAR1000_8_sweeper.RxGain8 = self.Rx8Gain
    ...
    def set_Rx7_Cal(self, Rx7_Cal):
        ...
        self.ADAR1000_8_sweeper.Rx7_cal = float(self.Rx7_Cal+self.Rx1_to_Rx2_Offset+112.5)
    ...
    def set_Rx7Gain(self, Rx7Gain):
        ...
        self.ADAR1000_8_sweeper.RxGain7 = self.Rx7Gain
    ...
    def set_Rx6_Cal(self, Rx6_Cal):
        ...
        self.ADAR1000_8_sweeper.Rx6_cal = float(self.Rx6_Cal+self.Rx1_to_Rx2_Offset+101.25)
    ...
    def set_Rx6Gain(self, Rx6Gain):
        ...
        self.ADAR1000_8_sweeper.RxGain6 = self.Rx6Gain
    ...
    def set_Rx5_Cal(self, Rx5_Cal):
        ...
        self.ADAR1000_8_sweeper.Rx5_cal = float(self.Rx5_Cal+self.Rx1_to_Rx2_Offset+75.9375)
    ...
    def set_Rx5Gain(self, Rx5Gain):
        ...
        self.ADAR1000_8_sweeper.RxGain5 = self.Rx5Gain
    ...
    def set_Rx4_Cal(self, Rx4_Cal):
        ...
        self.ADAR1000_8_sweeper.Rx4_cal = float(self.Rx4_Cal)
    ...
    def set_Rx4Gain(self, Rx4Gain):
        ...
        self.ADAR1000_8_sweeper.RxGain4 = self.Rx4Gain
    ...
    def set_Rx3_Cal(self, Rx3_Cal):
        ...
        self.ADAR1000_8_sweeper.Rx3_cal = float(self.Rx3_Cal+11.25)
    ...
    def set_Rx3Gain(self, Rx3Gain):
        ...
        self.ADAR1000_8_sweeper.RxGain3 = self.Rx3Gain
    ...
    def set_Rx2_Cal(self, Rx2_Cal):
        ...
        self.ADAR1000_8_sweeper.Rx2_cal = float(self.Rx2_Cal+30.9375)
    ...
    def set_Rx2Gain(self, Rx2Gain):
        ...
        self.ADAR1000_8_sweeper.RxGain2 = self.Rx2Gain
    ...
    def set_Rx1_Cal(self, Rx1_Cal):
        ...
        self.ADAR1000_8_sweeper.Rx1_cal = float(self.Rx1_Cal+33.75)
    ...
    def set_Rx1Gain(self, Rx1Gain):
        ...
        self.ADAR1000_8_sweeper.RxGain1 = self.Rx1Gain
    ...
    def set_IgnorePhaseCals(self, IgnorePhaseCals):
        ...
        self._IgnorePhaseCals_callback(self.IgnorePhaseCals)
        self.ADAR1000_8_sweeper.PhaseCal = int(self.IgnorePhaseCals)
    ...
    def set_BeamTaper(self, BeamTaper):
        ...
        self._BeamTaper_callback(self.BeamTaper)
        self.ADAR1000_8_sweeper.Taper = int(self.BeamTaper)
