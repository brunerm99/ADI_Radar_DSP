...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.Center_freq = Center_freq = 10500.0
        self.BW = BW = 0
        ...
        for c in range(0, 2):
            self.ControlTab_grid_layout_2.setColumnStretch(c, 1)
        self._Center_freq_range = Range(10000, 11000, 0.1, 10500.0, 10)
        ...
        for c in range(2, 5):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.epy_block_0 = epy_block_0.blk(SDR_ip='ip:set_in_program', LO_freq=int((Center_freq-10*1000)*1000000), TX_freq=int(0.5*1000*1000000), SampleRate=int(samp_rate), Rx_gain=int(Rx_gain), Averages=int(Times_To_Average), Taper=int(BeamTaper), SymTaper=int(SymmetricTaper), PhaseCal=int(IgnorePhaseCals), SignalFreq=int((Center_freq-BW)*1000000), RxGain1=int(Rx1Gain), RxGain2=int(Rx2Gain), RxGain3=int(Rx3Gain), RxGain4=int(Rx4Gain), Rx1_cal=Rx1_Cal, Rx2_cal=Rx2_Cal+25.3125, Rx3_cal=Rx3_Cal+19.6875, Rx4_cal=Rx4_Cal+8.4375)
    ...
    def set_Center_freq(self, Center_freq):
        ...
        self.epy_block_0.LO_freq = int((self.Center_freq-10*1000)*1000000)
    ...
    def set_Rx4_Cal(self, Rx4_Cal):
        ...
        self.epy_block_0.Rx4_cal = self.Rx4_Cal+8.4375
    ...
    def set_Rx3_Cal(self, Rx3_Cal):
        ...
        self.epy_block_0.Rx3_cal = self.Rx3_Cal+19.6875
    ...
    def set_Rx2_Cal(self, Rx2_Cal):
        ...
        self.epy_block_0.Rx2_cal = self.Rx2_Cal+25.3125
