...
class App:  
    def __init__(self, master):      
        '''SET DEFAULT VALUES'''
        self.sdr_address = 'ip:192.168.2.1'   # This is the default Pluto address (You can check/change this in the config.txt file on the Pluto "usb drive")
        self.SignalFreq = 10.495e9
        self.TX_freq    = 5.80e9          # TX LO freq.  This is the freq that Pluto generates (if using the Tx of Pluto as a crude LO)
        self.Mixer_LO   = 9.5e9   #self.TX_freq       # This is the Mixer LO.  Could be equal to self.TX_freq.  Or if ADF4371 is used for the LO freq, then set this to 9.5 GHz because I haven't built a way to arbitrarily set the 4371 freq....  I should have just used the ADF4371 linux driver.... I'll work on it....
        ...
        self.RxGain7 = 127
        self.RxGain8 = 127
        self.Rx1_cal = 36.5625   # you can put phase cal values here (to compensate for phase mismatches in the lines, etc.)
        self.Rx2_cal = 22.5
        self.Rx3_cal = 30.9375
        self.Rx4_cal = 0
        self.Rx5_cal = -73.1250
        self.Rx6_cal = -64.6875
        self.Rx7_cal = -53.4375
        self.Rx8_cal = -39.3750
