...
class App:  
    def __init__(self, master):      
        '''SET DEFAULT VALUES'''
        self.sdr_address = self.sdr_address
        self.SignalFreq = self.SignalFreq
        self.TX_freq    = self.TX_freq          # TX LO freq.  This is the freq that Pluto generates (if using the Tx of Pluto as a crude LO)
        self.Mixer_LO   = self.Mixer_LO         # This is the Mixer LO.  Could be equal to self.TX_freq.  Or if ADF4371 is used for the LO freq, then set this to 9.5 GHz because I haven't built a way to arbitrarily set the 4371 freq....  I should have just used the ADF4371 linux driver.... I'll work on it....
        ...
        self.RxGain7 = 127
        self.RxGain8 = 127
        self.Rx1_cal = -8.4375   # you can put phase cal values here (to compensate for phase mismatches in the lines, etc.)
        self.Rx2_cal = 0
        self.Rx3_cal = -5.625
        self.Rx4_cal = 11.25
        self.Rx5_cal = 0
